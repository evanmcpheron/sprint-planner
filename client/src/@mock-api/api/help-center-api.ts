...
export const helpCenterApiMocks = (mock: ExtendedMockAdapter) => {
	mock.onGet('/help-center/faqs').reply(() => [200, faqsDB]);

	mock.onGet('/help-center/faqs/categories').reply(() => [200, faqCategoriesDB]);
	...
	mock.onGet('/help-center/guides').reply(() => [200, guidesDB]);

	mock.onGet('/help-center/guides/categories').reply(() => [200, guideCategoriesDB]);
