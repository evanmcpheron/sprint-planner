...
/**
 * OlorinNavVerticalGroup is a component used to render a group of navigation items in a vertical layout.
 */
function OlorinNavVerticalGroup(props: OlorinNavItemComponentProps) {
		...
		() => (
			<>
				<Root
					...
					className={clsx(
						'olorin-list-subheader flex items-center  py-10',
				...
				>
					<ListItemText
						className="olorin-list-subheader-text"
						sx={{
							margin: 0,
...
const NavVerticalGroup = OlorinNavVerticalGroup;
