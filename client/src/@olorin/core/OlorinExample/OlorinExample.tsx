...
/**
 * OlorinExample component gives a visual display as well as code for a component example.
 * It consists of two tabs, a visual tab and code tab.
 */
function OlorinExample(props: OlorinExampleProps) {
				...
				>
					{Component && (
						<Tab
							...
							icon={<OlorinSvgIcon>heroicons-outline:eye</OlorinSvgIcon>}
						/>
					)}
					{raw && (
						<Tab
							classes={{ root: 'min-w-64' }}
							icon={<OlorinSvgIcon>heroicons-outline:code</OlorinSvgIcon>}
						/>
					)}
				</Tabs>
			</Box>
