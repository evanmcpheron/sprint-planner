 ...
 */
const OlorinHighlight = forwardRef<HTMLDivElement, OlorinHighlightProps>((props, ref) => {
...
function trimCode(children: OlorinHighlightProps['children']) {
	...
	// can be formatted properly while using olorin-highlight
	// component
...
export default memo(styled(OlorinHighlight)``);
