import { useDebounce, usePrevious } from '@olorin/hooks';
...
import ThemeFormConfigTypes from '@olorin/core/OlorinSettings/ThemeFormConfigTypes';
...
/**
 * The Root styled component is used to style the root div of the OlorinSettings component.
 * It uses the styled function from the MUI styles library to create a styled component.
 */
const Root = styled('div')(({ theme }) => ({
	'& .OlorinSettings-formControl': {
		margin: '6px 0',
		width: '100%',
		'&:last-child': {
			marginBottom: 0,
	...
	'& .OlorinSettings-group': {},

	'& .OlorinSettings-formGroupTitle': {
		position: 'absolute',
		top: -10,
		left: 8,
		fontWeight: 600,
...
export type OlorinThemeType = {
	palette: PartialDeep<Palette>;
};

export type OlorinThemesType = { [key: string]: OlorinThemeType };

export type OlorinSettingsConfigType = {
	layout: {
		style?: string;
	...
	direction: 'rtl' | 'ltr';
	theme: {
		main: OlorinThemeType;
		navbar: OlorinThemeType;
		toolbar: OlorinThemeType;
		footer: OlorinThemeType;
	};
	defaultAuth?: string[];
...
/**
 * The OlorinSettings component is responsible for rendering the settings form for the Olorin React application.
...
function OlorinSettings() {
	...
	const handleUpdate = useDebounce((newSettings: OlorinSettingsConfigType) => {
				...
				switch (formControl.type) {
						...
						return (
							<Controller
								...
								render={({ field }) => (
									<FormControl
										component="fieldset"
										className="OlorinSettings-formControl"
									>
										<FormLabel
											component="legend"
											className="text-14"
										...
										<RadioGroup
											...
											className="OlorinSettings-group"
					...
					case 'group': {
						return (
							<div
								key={target}
								className="OlorinSettings-formGroup"
							>
								<Typography
									className="OlorinSettings-formGroupTitle"
	...
	return (
		<Root>
			<div className="OlorinSettings-formGroup">
				<Typography
					className="OlorinSettings-formGroupTitle"
					color="text.secondary"
				>
			...
			<div className="OlorinSettings-formGroup pb-16">
				<Typography
					className="OlorinSettings-formGroupTitle"
					color="text.secondary"
				>
...
export default memo(OlorinSettings);
