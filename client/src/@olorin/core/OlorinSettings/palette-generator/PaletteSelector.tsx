...
import { OlorinThemeType } from '../OlorinSettings';
...
type PaletteSelectorProps = {
	...
	value: OlorinThemeType;
	onChange: (value: OlorinThemeType) => void;
};
...
function PaletteSelector(props: PaletteSelectorProps) {
	...
	const methods = useForm<OlorinThemeType>({
		defaultValues: {},
		mode: 'onChange',
	});
	...
	function onSubmit(formData: OlorinThemeType) {
		onChange(formData);
		handleCloseDialog();
	}
