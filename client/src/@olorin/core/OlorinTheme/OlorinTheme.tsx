...
/**
 * The OlorinTheme component is responsible for rendering the MUI ThemeProvider component with the specified theme and direction.
 * It also sets the direction of the document body and adds a class to the body based on the current theme mode.
 * The component is memoized to prevent unnecessary re-renders.
 */
function OlorinTheme(props: OlorinThemeProps) {
	...
	// console.warn('OlorinTheme:: rendered',mainTheme);
	return (
...
export default memo(OlorinTheme);
