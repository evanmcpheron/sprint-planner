import { olorinDark } from '@olorin/colors';
...
/**
 * The defaultSettings object defines the default settings for the Olorin application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Olorin application.
 * It returns a OlorinSettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings() {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as OlorinSettingsConfigType;
	}
