				...
				<List>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<OlorinSvgIcon>material-outline:notifications</OlorinSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<OlorinSvgIcon>material-outline:cloud</OlorinSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<OlorinSvgIcon>material-outline:brightness_high</OlorinSvgIcon>
						</ListItemIcon>
