...
:::warning
The `Grid` component shouldn't be conolorind with a data grid; it is closer to a layout grid. For a data grid head to [the `DataGrid` component](/x/react-data-grid/).
:::
