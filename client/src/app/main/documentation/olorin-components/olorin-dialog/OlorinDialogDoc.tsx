...
import { closeDialog, openDialog } from '@olorin/core/OlorinDialog/olorinDialogSlice';

/**
 * OlorinDialog Doc
 * This document provides information on how to use the OlorinDialog.
 */
function OlorinDialogDoc() {
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				<code>OlorinDialog</code>
{' '}
is a simple dialog trigger for easily showing dialog messages via redux
...
export default OlorinDialogDoc;
