	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				Olorin React utilizes a custom routing system based on the popular packages
				<a
...
{' '}
			...
			<Typography
				...
				component="p"
			>
				Olorin React follows a modular approach and is based on route settings determined from config files.
			</Typography>
...
{' '}
<code>MailboxAppConfig.tsx</code>
. Here you can override all
			...
			<Typography
				...
				component="p"
			>
				The routes are then generated in
{' '}
