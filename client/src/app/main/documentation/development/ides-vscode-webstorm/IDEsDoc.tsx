	...
	return (
		<>
			...
			>
				...
				potential errors. To use them with Webstorm, we are using ESLint with
{' '}
<b>eslint-plugin-prettier</b>
. To
				reformat the current file/folder, use the
{' '}
<b>Fix ESLint Problems</b>
{' '}
action. You can find it using Find
				Action (Cmd/Ctrl-Shift-A) or add a keyboard shortcut to it in
{' '}
...
.
			...
			>
				...
				the extension sidebar in VSCode. Here is an example
{' '}
<b>settings.json</b>
{' '}
