 ...
 * This document explains the directory structure and naming conventions used in Olorin React.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				This document explains the directory structure and naming conventions used in Olorin React. Olorin React
				is a modular approach based on route settings determined from config files. The directory structure and
			...
			<Typography
				...
				component="p"
			>
				The directory structure of Olorin React is organized by feature, with each feature having its own
...
{' '}
named in lowercase and use hyphens to separate words. Example: `chat`,
				`contacts`.
			</Typography>
			<Typography
				className="mb-16"
			...
			>
				<strong>Files:</strong>
{' '}
named in PascalCase and use the name of the component, type, or model they
...
{' '}
named in PascalCase and use the name of the component they represent.
...
{' '}
named in PascalCase and use the name of the model they represent. Example:
				`ContactModel.tsx`.
			</Typography>
			<Typography
				className="mb-16"
				component="p"
			>
				<strong>Sidebars/Tabs/Sections/Dialogs etc:</strong>
{' '}
For example Sidebar named in PascalCase and use the
...
{' '}
named in camelCase and use the name of the slice they represent. Example:
...
{' '}
have api endpoints and named in PascalCase. RTK Query is used for API calls.
...
{' '}
named in PascalCase and use the name of the feature they represent,
			...
			<Typography
				...
				component="p"
			>
				Olorin React's directory structure might look overwhelming and intimidating at first, but following this
