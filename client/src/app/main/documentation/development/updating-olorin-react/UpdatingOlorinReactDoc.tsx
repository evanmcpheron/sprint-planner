...
/**
 * Updating Olorin React Doc
 * This document provides information on how to update Olorin React.
 */
function UpdatingOlorinReactDoc() {
	return (
		<>
			<Typography
				variant="h4"
			...
			<Typography
				...
				component="p"
			>
				Olorin React isn’t an end product or an extension so there is no easy way to update the project. Due to
				the nature of apps, we cannot give any set instructions for updating Olorin React. It heavily depends on
				your project and it's up to you to update your code. However, there are a couple points that we want to
				put forward which might help you to keep Olorin React updated:
			</Typography>
			...
			>
				<ol>
					<li className="mb-16">
						The most important one is not to touch the /@olorin directory but sometimes that is going to be
...
{' '}
						...
						changes manually, but it's the best way to keep the Olorin React updated.
					</li>
				</ol>
			</Typography>
		</>
...
export default UpdatingOlorinReactDoc;
