	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				Olorin comes with a variety of different Theme Layouts which you can see and try them from the
...
: Each layouts shares the components of this directory
					...
					<li className="mb-8">
						<b>/themeLayoutConfigs.tsx</b>
{' '}
: Imports all layout configs.
					</li>
					<li className="mb-8">
						<b>/themeLayouts.tsx</b>
{' '}
: Imports all layout components.
			...
			<Typography
				...
				component="p"
			>
				Olorin React has a powerful layout system which allows you to configure and use a different layout per
				route.
			</Typography>
			...
			>
				...
				page where there isn't any toolbar or navbar showing, without leaving the Olorin React.
			</Typography>
