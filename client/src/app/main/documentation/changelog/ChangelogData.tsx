...
const changelogData: ChangelogItemType[] = [
	...
	},
	{
		...
		newChanges: [
			<>
				<Link to="/apps/settings">Settings App/Page</Link>
{' '}
created.
			</>,
		],
	...
	},
	{
		...
		fixedChanges: [
			...
			'OlorinSearch: Misaligned popper issue resolved in horizontal layouts.',
		],
	...
	},
	{
		...
		breakingChanges: [
			...
			'olorin, auth, navigation, settings slices lazy loaded from its own components with HOC',
		],
		notes: (
...
{' '}
					...
					<Typography
						...
						className="leading-loose"
					>
						Starting with the latest skeleton version of Olorin React offers a pristine base, facilitating a
...
{' '}
					...
					<Typography
						...
						className="leading-loose"
					>
						You may also want to consider starting with the latest skeleton version of Olorin React, which
						is a clean slate, and then move your codebase to the new version. This can make the migration
...
{' '}
	...
	},
	{
		...
		fixedChanges: [
			'OlorinPageCarded Sidebar width value not applied on mobile.',
			'OlorinPageSimple Sidebar width value not applied on mobile.',
		],
	},
	{
		version: '8.2.2',
		...
		fixedChanges: [
			...
			'Performance refinements on OlorinExample, OlorinHighlight components, OlorinSvgIcon',
		],
	},
	{
		version: '8.2.1',
	...
	},
	{
		...
		fixedChanges: ['Theme Layout Navbar styles theming', 'OlorinSidePanel max-height'],
	},
	{
		version: '8.1.0',
		date: '2022-07-14',
			...
			<div className="text-14 p-24 border-2 border-red rounded-16 w-full max-w-lg mt-40 mb-24">
				<ul className="list-disc">
					<Typography
						...
						className="leading-loose mb-16"
					>
						This is the new major version of the Olorin React and it's completely different from previous
	...
	},
	{
		...
		breakingChanges: [
			...
			'OlorinAnimate, OlorinGroupAnimate, OlorinChipSelect Components are deprecated.',
		],
		notes: (
			<div className="text-14 p-24 border-2 rounded-16 w-full max-w-lg mt-40 mb-24">
				<ul className="list-disc">
...
{' '}
	...
	},
	{
		...
		fixedChanges: ['OlorinChipSelect empty input height.'],
	},
	{
		version: '5.3.0',
		date: '2020-12-02',
	...
	},
	{
		...
		newChanges: [
			...
			'OlorinSearch: placeholder and noResults props added for localization.',
	...
	},
	{
		...
		fixedChanges: [
			'OlorinDialog and OlorinMessage actions added into serializableCheck ignoredActions list.',
			...
			'OlorinSearch, OlorinShortcuts cannot find translated navigation item, translation process moved into the redux store.',
		],
	},
	{
		version: '5.0.0',
...
- createEntityAdapter function generates a set of prebuilt reducers and selectors for
					...
					<br />
					<b>With the changes, We've removed ~57 redux related files from the olorin-react.</b>
				</Typography>
			</>
		),
	},
	...
	},
	{
		...
		fixedChanges: ['OlorinChipSelect error highligting.'],
	},
	{
		version: '4.0.1',
		date: '2020-02-16',
	...
	},
	{
		...
		fixedChanges: [
			...
			'RTL OlorinScrollbars issue solved.',
		],
		breakingChanges: [
			<span>
			...
			'@olorin directories re-structured (@olorin/components > @olorin/core etc.), top level imports removed from @olorin/index, import paths updated.',
	...
	},
	{
		...
		newChanges: [
			...
			'"redirect the logged-in user to a specific route depending on his role" title added into the OlorinAuthorization Doc.',
		],
		fixedChanges: [
	...
	},
	{
		...
		fixedChanges: ['OlorinPage layout components: Drawer closes whenever click on it.'],
	},
	{
		version: '3.2.4',
		date: '2019-10-24',
		newChanges: [
			...
			'All dependency packages updated.',
			'@fake-db/mock.js).',
			'E-Commerce App, shows OlorinLoading component while product data is loading.',
			'Contacts App Contact Dialog Mobile refinement for scroll.',
			'Calendar App Native date input changed with DateTimePicker.',
			'OlorinNavigation, dense attr added for densed variation.',
		],
		fixedChanges: [
			'NavbarMobileToggleFab Button added for to display absence of the toolbar.',
			<span>
				react-select returns null despite of empty array, workaround applied for OlorinChipSelect.
				<a
	...
	},
	{
		...
		newChanges: [
			...
			'All dependency packages updated.',
			'OlorinChipSelectFormsy Component added.',
			'Default OlorinSuspense loading delay changed to 0.',
		],
		fixedChanges: ['OlorinHorizontalNav items minor theming issues.', 'Minor fixes for dependency updates.'],
	},
	{
		version: '3.2.2',
		date: '2019-08-09',
		newChanges: [
			...
			'scrollToTopOnRouteChange added to OlorinScrollbars.',
			<span>
...
<code>{'name="profile.username" value={form.profile.username}'}</code>
		...
		fixedChanges: [
			'scrollToTopOnChildChange changed with scrollToTopOnRouteChange in OlorinPageCarded.',
	...
	},
	{
		...
		fixedChanges: [
			'OlorinLayout do not hold render until settings at the redux state is updated. This causes multiple mount of the route component which has different layout settings.',
			'Layout style issues due to browser updates.',
			'Removal of event listeners in OlorinScrollbars (@stephankaag).',
		],
	},
	{
		version: '3.2.0',
	...
	},
	{
		...
		newChanges: [
			...
			<span>
				...
				<a
					href="http://react-material.olorintheme.com/documentation/olorin-components/olorin-authorization"
					target="_blank"
					rel="noopener noreferrer"
				>
					OlorinAuthorization Docs
				</a>
				.
			</span>,
			'All dependency packages updated.',
		...
		fixedChanges: [
			<span>
				<i>"createBrowserHistroy is not exported from history.tsx"</i>
{' '}
...
<b>v3.0.0</b>
	...
	},
	{
		version: '2.2.4',
		date: '2019-03-06',
		newChanges: ['Dependency packages updated (react v16.8.4 etc).', 'setRef prop added to OlorinAnimate.'],
		fixedChanges: [
	...
	},
	{
		...
		fixedChanges: [
			'Olorin vertical navigation collapse items don’t have to be collapsed whenever navigation updated or location path changed.',
		],
		breakingChanges: [
			'src/styles/olorin-helpers.css renamed with src/styles/tailwind.css',
			'src/styles/olorin-helpers.tailwind.css renamed with src/styles/tailwind.base.css',
		],
	},
	{
		version: '2.2.2',
		...
		fixedChanges: [
			...
			'Theming issues (OlorinCountdown, tables of Invoice pages).',
		],
	},
	{
		version: '2.2.1',
		...
		newChanges: [
			...
			'OlorinNavigation update,remove,append,prepend actions created, documentation page is updated.',
	...
	},
	{
		...
		newChanges: [
			...
			"External Link Item added to OlorinNavigation (type:'link').",
	...
	},
	{
		...
		fixedChanges: [
			...
			'OlorinSearch did not hide auth protected navigation items.',
		],
	},
	{
		version: '2.0.0',
		...
		newChanges: [
			...
			'OlorinSidePanel created and used in layout-3.',
			'OlorinNavigation: dense variant added for horizontal layout only.',
			'OlorinShortcuts: vertical variant added.',
			'OlorinSearch: basic variant added (checkout layout-3)',
		...
		fixedChanges: [
			...
			'Some IE fixes.',
			'OlorinAuthorization must have state to prevent restricted route component mount when unauthorized user redirects.',
			"E-Commerce App, navigating product to new product didn't update the form state.",
			'Authentication timing issues fixed.',
		],
		breakingChanges: [
			'Theme layouts moved out of the @olorin core files which gives developers to create or edit theme layouts easily.',
			'Project structure changed after new layout system.',
			'Theme configuration state moved from OlorinTheme to redux store (olorin.settings).',
		],
		notes: (
			<Typography
				className="text-14 p-12 border-2 rounded-16 w-full max-w-lg mt-16"
	...
	},
	{
		...
		newChanges: [
			'Academy App added.',
			'OlorinSearch Component added (located at the main toolbar and searches in the navigation).',
			'OlorinChipSelect documentation page added.',
			'Dependency packages updated (Material-ui etc).',
		],
		fixedChanges: [
			'Missing input variants added to Formsy Higher Order Components.',
			'OlorinChipSelect variant styles fixed.',
			'OlorinNavHorizontalItem missing exact prop added.',
			"E-Commerce App, navigating product to new product didn't update the form state.",
			'Authentication timing issues fixed.',
		],
	},
	{
		...
		newChanges: [
			...
			'OlorinMessage variations added (error, success, alert, info).',
			'Dependency packages updated (Material-ui etc).',
		],
		fixedChanges: [
			'OlorinMessage relocated (position changed absolute to fixed).',
	...
	},
	{
		...
		date: '2018-11-06',
		newChanges: [
			'OlorinDialog Component added to theme layout for easily show dialog messages via redux action.',
	...
	},
	{
		...
		newChanges: [
			...
			'OlorinLoadable component created for to avoid repetition.',
	...
	},
	{
		...
		newChanges: [
			...
			'OlorinChipSelect: "variant" attr added for to choose creatable or fixed multi selection.',
			'Dependency packages updated.',
	...
	},
	{
		...
		newChanges: [
			...
			'OlorinChipSelect Component added.',
...
component added as entry point for
	...
	},
	{
		...
		fixedChanges: [
			'OlorinAnimate, OlorinAnimateGroup inject error.',
...
{' '}
added as dependency, its used for olorinAnimation
			</span>,
			<span>
				<code>OlorinAnimation</code>
{' '}
<code>OlorinAnimationGroup</code>
{' '}
...
updated to v1.2.0
		...
		fixedChanges: [
			...
			'Actions and reducers of olorin navigation fixed.',
		],
		breakingChanges: [
			...
			'OlorinSettings separated from the settings panel.',
		],
	},
	{
		version: '1.0.5',
...
updated to v1.0.0
			...
			'OlorinMessage Component added to theme layout for easily show snackbar messages via redux action.',
		],
		breakingChanges: [
			<span>
				<code>OlorinAuth</code>
{' '}
renamed with OlorinAuthorization
			</span>,
