...
/**
 * Installation Doc
 * This document provides information on how to install Olorin React.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				To install and use Olorin React, you will need
{' '}
				<a
...
{' '}
			...
			<Typography
				...
				variant="h6"
			>
				B. Installing Olorin React
			</Typography>

			<Typography component="div">
				Before you begin installing Olorin, prepare a folder where you can unzip the downloaded .zip file.
			</Typography>
				...
				<ul className="list-disc mx-16">
					<li>
						...
						>
							Demo TS
{' '}
<b>Olorin-react-x.x.x-ts-demo.zip</b>
							<br />
							Demo JS
{' '}
<b>Olorin-react-x.x.x-js-demo.zip</b>
						</Typography>
						<Typography
							className="mt-12"
							component="div"
						...
						>
							<b>DO NOT</b>
{' '}
use the Demo version to build your app, otherwise you will have a lot of
					...
					<li>
						...
						>
							Skeleton TS
{' '}
<b>Olorin-react-x.x.x-ts-skeleton.zip</b>
							<br />
							Skeleton JS
{' '}
<b>Olorin-react-x.x.x-js-skeleton.zip</b>
						</Typography>
						<Typography
							className="mt-12"
							component="div"
						>
							...
							functionality of Olorin without the Demo applications, pages and UI sections.
{' '}
<b>DO</b>
{' '}
use
