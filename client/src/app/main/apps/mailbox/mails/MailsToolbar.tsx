	...
	return (
		<div className="sticky top-0 z-10">
				...
				<OutlinedInput
					...
					startAdornment={
						<InputAdornment position="start">
							<OlorinSvgIcon color="disabled">heroicons-solid:search</OlorinSvgIcon>
						</InputAdornment>
					}
					inputProps={{
						'aria-label': 'Search',
			...
			>
				...
				>
					<OlorinSvgIcon size={16}>heroicons-outline:chevron-down</OlorinSvgIcon>
				</IconButton>
					...
					<>
						...
						<Tooltip title="Move to folder">
							<IconButton
								...
								size="small"
							>
								<OlorinSvgIcon>heroicons-outline:folder</OlorinSvgIcon>
							</IconButton>
						</Tooltip>
						...
						<Tooltip title="Set important">
							<IconButton
								...
								size="small"
							>
								<OlorinSvgIcon className="text-red-600 dark:text-red-500">
						...
						<Tooltip title="Set starred">
							<IconButton
								...
								size="small"
							>
								<OlorinSvgIcon className="text-orange-500 dark:text-red-400">
