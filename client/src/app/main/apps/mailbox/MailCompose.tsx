	...
	return (
		<div className={clsx('', className)}>
			<Button
				...
				startIcon={<OlorinSvgIcon>heroicons-outline:plus</OlorinSvgIcon>}
			>
				{t('COMPOSE')}
			</Button>
			...
			>
				...
				>
					...
					<DialogActions className="flex flex-col sm:flex-row sm:items-center justify-between py-16 sm:py-24 px-24">
						<div className="-mx-8">
							<IconButton>
								<OlorinSvgIcon size={20}>heroicons-solid:paper-clip</OlorinSvgIcon>
							</IconButton>

							<IconButton>
								<OlorinSvgIcon size={20}>heroicons-solid:link</OlorinSvgIcon>
							</IconButton>

							<IconButton>
								<OlorinSvgIcon size={20}>heroicons-solid:emoji-happy</OlorinSvgIcon>
							</IconButton>

							<IconButton>
								<OlorinSvgIcon size={20}>heroicons-solid:photograph</OlorinSvgIcon>
							</IconButton>
						</div>
