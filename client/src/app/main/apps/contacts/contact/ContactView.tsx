...
function ContactView() {
	...
	if (isLoading) {
		return <OlorinLoading className="min-h-screen" />;
	}
					...
					<div className="flex flex-auto items-end -mt-64">
						...
						<div className="flex items-center ml-auto mb-4">
							<Button
								...
								to="edit"
							>
								<OlorinSvgIcon size={20}>heroicons-outline:pencil-alt</OlorinSvgIcon>
					...
					<div className="flex flex-col space-y-32">
						{contact.title && (
							<div className="flex items-center">
								<OlorinSvgIcon>heroicons-outline:briefcase</OlorinSvgIcon>
						...
						{contact.company && (
							<div className="flex items-center">
								<OlorinSvgIcon>heroicons-outline:office-building</OlorinSvgIcon>
						...
						{contact?.emails?.length && contact.emails.some((item) => item.email?.length > 0) && (
							<div className="flex">
								<OlorinSvgIcon>heroicons-outline:mail</OlorinSvgIcon>
						...
						{contact?.phoneNumbers &&
							...
							contact.phoneNumbers.some((item) => item.phoneNumber?.length > 0) && (
								<div className="flex">
									<OlorinSvgIcon>heroicons-outline:phone</OlorinSvgIcon>
									<div className="min-w-0 ml-24 space-y-4">
						...
						{contact.address && (
							<div className="flex items-center">
								<OlorinSvgIcon>heroicons-outline:location-marker</OlorinSvgIcon>
						...
						{contact.birthday && (
							<div className="flex items-center">
								<OlorinSvgIcon>heroicons-outline:cake</OlorinSvgIcon>
						...
						{contact.notes && (
							<div className="flex">
								<OlorinSvgIcon>heroicons-outline:menu-alt-2</OlorinSvgIcon>
								<div
