...
function BirtdayIcon() {
	return <OlorinSvgIcon size={20}>heroicons-solid:cake</OlorinSvgIcon>;
}
									...
									<div className="absolute inset-0 flex items-center justify-center z-20">
										<div>
											...
											>
												...
												/>
												<OlorinSvgIcon className="text-white">
					...
					render={({ field }) => (
						<TextField
							...
							InputProps={{
								startAdornment: (
									<InputAdornment position="start">
										<OlorinSvgIcon size={20}>heroicons-solid:location-marker</OlorinSvgIcon>
									</InputAdornment>
								),
							}}
						/>
