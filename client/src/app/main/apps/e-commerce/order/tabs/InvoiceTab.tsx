					...
					<CardContent className="p-88 print:p-0">
						...
						<div className="flex justify-between">
							...
							<div className="seller flex items-center p-16">
								...
								<div className="px-8">
									<Typography color="inherit">OLORIN INC.</Typography>
									...
									<Typography color="inherit">hello@olorininc.com</Typography>
									<Typography color="inherit">www.olorininc.com</Typography>
								</div>
							</div>
						</div>
