...
function NotificationPanel() {
	...
	useEffect(() => {
		const item = NotificationModel({
			title: 'New Olorin React version is released! ',
	...
	return (
		...
		>
			<IconButton
				...
				size="large"
			>
				<OlorinSvgIcon color="action">heroicons-outline:x</OlorinSvgIcon>
			</IconButton>

			<OlorinScrollbars className="flex flex-col p-16 h-full">
