						...
						<div className="flex justify-center w-full sticky bottom-0 p-16 pb-32 z-10">
							...
							>
								<Button
									...
									size="large"
									startIcon={<OlorinSvgIcon>heroicons-outline:arrow-narrow-left</OlorinSvgIcon>}
									onClick={handleBack}
								>
									Prev
								</Button>
								<Button
									...
									size="large"
								>
{`${activeStep}/${course.totalSteps}`}
        </Button>
								<Button
									className="min-h-56 rounded-full"
									size="large"
									endIcon={<OlorinSvgIcon>heroicons-outline:arrow-narrow-right</OlorinSvgIcon>}
									onClick={handleNext}
								>
									Next
								</Button>
					...
					<Hidden lgUp>
						...
						>
							...
							<IconButton onClick={handleBack}>
								<OlorinSvgIcon>heroicons-outline:arrow-narrow-left</OlorinSvgIcon>
							</IconButton>

							<IconButton onClick={handleNext}>
								<OlorinSvgIcon>heroicons-outline:arrow-narrow-right</OlorinSvgIcon>
							</IconButton>
						</Box>
					</Hidden>
				</div>
