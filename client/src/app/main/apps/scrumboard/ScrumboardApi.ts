...
export type GetScrumboardBoardListsApiArg = string;
...
export type GetScrumboardMemberApiArg = string;
...
export type DeleteScrumboardMemberApiArg = string;
...
export type GetScrumboardBoardLabelsApiArg = string;
...
export type GetScrumboardBoardCardListApiArg = string;
...
export type GetScrumboardBoardApiArg = string;
...
export type DeleteScrumboardBoardApiArg = string;
