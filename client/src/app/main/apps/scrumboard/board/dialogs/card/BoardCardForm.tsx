import { useDebounce, useDeepCompareEffect } from '@olorin/hooks';
			...
			<div className="flex flex-auto flex-col py-16 px-0 sm:px-16">
				<div className="flex flex-col sm:flex-row sm:justify-between justify-center items-center mb-24">
					<div className="mb-16 sm:mb-0 flex items-center">
						...
						<OlorinSvgIcon size={20}>heroicons-outline:chevron-right</OlorinSvgIcon>
				...
				{cardForm.memberIds && cardForm.memberIds.length > 0 && (
					<div className="flex-1 mb-24 mx-8">
						<div className="flex items-center mt-16 mb-12">
							<OlorinSvgIcon size={20}>heroicons-outline:users</OlorinSvgIcon>
						...
						<Autocomplete
							...
							freeSolo
							options={members}
							getOptionLabel={(member: string | ScrumboardMember) => typeof member === 'string' ? member : member?.name}
				...
				{cardForm.attachments && cardForm.attachments.length > 0 && (
					<div className="mb-24">
						<div className="flex items-center mt-16 mb-12">
							<OlorinSvgIcon size={20}>heroicons-outline:paper-clip</OlorinSvgIcon>
				...
				<div className="mb-24">
					<div className="flex items-center mt-16 mb-12">
						<OlorinSvgIcon size={20}>heroicons-outline:chat-alt</OlorinSvgIcon>
							...
							{value.length > 0 && (
								<div className="mb-24">
									<div className="flex items-center mt-16">
										<OlorinSvgIcon size={20}>heroicons-outline:clipboard-list</OlorinSvgIcon>
						...
						<Controller
							...
							render={() => (
								<IconButton size="large">
									<OlorinSvgIcon>heroicons-outline:paper-clip</OlorinSvgIcon>
								</IconButton>
							)}
						/>
