		...
		<div className="mb-24">
			<div className="flex items-center justify-between mt-16 mb-12">
				<div className="flex items-center">
					<OlorinSvgIcon size={20}>heroicons-outline:check-circle</OlorinSvgIcon>
					<Controller
						name="name"
						control={control}
						defaultValue=""
				...
				<div>
					<IconButton
						...
						size="small"
					>
						<OlorinSvgIcon size={20}>heroicons-outline:dots-vertical</OlorinSvgIcon>
					</IconButton>
					<Menu
						id="actions-menu"
						anchorEl={anchorEl}
					...
					>
						...
						<MenuItem onClick={handleOpenNameForm}>
							<ListItemIcon className="min-w-40">
								<OlorinSvgIcon>heroicons-outline:pencil</OlorinSvgIcon>
							</ListItemIcon>
