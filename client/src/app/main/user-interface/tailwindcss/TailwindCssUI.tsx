			...
			content={
				<div className="flex-auto p-24 sm:p-40">
					<div>
						...
						<Typography className="mb-16">
							To simply put, Tailwind provides helper classes for almost every CSS rule available. Olorin
						...
						<Typography
							...
							component="p"
						>
							Olorin React developed based on Material-UI as ui library.
							<a
								className="mx-4"
							...
							uses emotion at its core. Therefore the Olorin React supports
							<a
								className="mx-4"
...
for fast
						...
						>
							...
							can find the config file of Tailwind with named "
<b>tailwind.js</b>
" under the root of
							Olorin React.
						</Typography>
