		...
		<Root
					...
					<div>
						{referenceUrl && (
							<Button
								...
								target="_blank"
								role="button"
								startIcon={<OlorinSvgIcon>heroicons-solid:external-link</OlorinSvgIcon>}
							>
								Official docs
							</Button>
						)}
			...
			content={
				<div className="flex-auto p-24 sm:p-40">
					...
					>
						{`
              <OlorinSvgIcon className="text-48" size={${form.size}} color="action">${iconName}:${selectedIcon}</OlorinSvgIcon>
            `}
					</OlorinHighlight>
